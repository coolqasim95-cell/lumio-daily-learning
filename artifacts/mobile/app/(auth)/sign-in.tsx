      ...
      <View style={[styles.container, { paddingTop: insets.top }]}>
        ...
        >
          ...
          <Pressable
            style={({ pressed }) => [
              styles.btn,
              (!verifyCode || isBusy) && styles.btnDisabled,
      ...
      >
        ...
        >
          ...
          <Pressable
            style={({ pressed }) => [
              styles.btn,
              (!email || !password || isBusy) && styles.btnDisabled,
              pressed && styles.btnPressed,
            ]}
...
const styles = StyleSheet.create({
  ...
  errorText: { color: "#FF6B6B", fontSize: 13, marginTop: -12, marginBottom: 16 },
});
